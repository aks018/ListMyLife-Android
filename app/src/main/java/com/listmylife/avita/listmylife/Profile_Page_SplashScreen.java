...
public class Profile_Page_SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(Profile_Page_SplashScreen.this);

        pd.setMessage("Retrieving All Friends...");
        ...
        databaseReferenceUsers.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                /* Create an Intent that will start the Menu-Activity. */
                        Intent mainIntent = new Intent(Profile_Page_SplashScreen.this,ProfilePage.class);
                        mainIntent.putExtra("hashmap", getUserNamesAndEmails);
                        Log.i("HASHMAP",getUserNamesAndEmails.toString());
                        Profile_Page_SplashScreen.this.startActivity(mainIntent);
                        Profile_Page_SplashScreen.this.finish();
                        pd.dismiss();
